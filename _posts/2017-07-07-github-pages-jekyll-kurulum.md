...
<figcaption>
   <a href="https://jekyllrb.com/" title="Jekyll"></a>Jekyll  ruby ile yazılmış basit ve güçlü bir altyapıya sahip olan statik bir site oluşturucudur.Markdown formatında yazdığımız sayfayı statik HTML sayfasına dönüştürür.Jekyll Github Pages tarafından desteklenen bir mekanizmadır.
</figcaption>
